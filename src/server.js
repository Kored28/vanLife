...
createServer({
    ...
    seeds(server) {
        ...
        server.create("user", { id: "456", email: "b1@b.com", password: "p456", name: "Ben" })
        server.create("user", { id: "789", email: "b2@b.com", password: "p789", name: "Bendict" })
    },
    ...
    routes() {
        ...
        this.post("/login", (schema, request) => {
            ...
            if (!foundUser) {
                throw Error( "No user with those credentials found!", {}, 401)
            }
